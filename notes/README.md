...
## Правило для прикладів від тренера

Тренер **завжди** показує нейтральний, виконуваний приклад синтаксису, коли вводить нову конструкцію. Приклад використовує іншу таблицю, колонку або умову, а не є готовим розв'язком твоєї поточної вправи. Так ти зберігаєш можливість розв'язати її самостійно.
